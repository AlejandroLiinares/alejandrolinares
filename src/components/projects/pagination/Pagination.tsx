...
const projectNames = ["SIO", "Roraimax", "Un millón de traumas"];

const Pagination = ({ total, current, onNext, onPrev, onDotClick }: PaginationProps) => {
      ...
      <div className={styles.paginationPill}>
        {Array.from({ length: total }).map((_, index) => (
          <span
            ...
            onClick={() => onDotClick(index)} // Funcionalidad de clic real
            title={projectNames[index]} // Tooltip nativo
